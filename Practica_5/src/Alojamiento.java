...
public class Alojamiento {
	...
	private String Xopero;
	
	public Alojamiento (String Etiqueta, String Instruccion,String Operando, String Dirr, String Local, String Xopero){
		super();
	...
	public String getXopero() {
		return Xopero;
	}
	public void setXopero(String Xopero) {
		this.Dirr = Xopero;
	}
	...
	String imprimirVector (int nlinea) {
		...
		System.out.println ("OPERO : " + xopero);
		
		ardillacu=gcloca+"\t\t\t"+xopero+"\t\t\t"+Etiquetav+"\t\t\t"+Instruccionv+"\t\t\t"+topoperando+"\n";
